...
namespace BurseFMI.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            Console.WriteLine($"C:\\Users\\Avram\\Desktop\\Burse-App\\liste\\{generateList.category}"+" DD");
        ...
        public ViewScholarshipsModel postViewScholarships(ViewScholarshipsModel viewScholarshipsModel, string status)
        {
            ...
            if (status.Equals(_strings.PENDING))
            {
                viewScholarshipsModel.sholarshipRequests=viewScholarshipsModel.sholarshipRequests.TakeLast(nrBurse.Value).ToList();
            }
